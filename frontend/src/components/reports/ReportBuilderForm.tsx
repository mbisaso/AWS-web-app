      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <StationDropdown
              stations={stations.map((s) => ({ station_id: String(s.id), name: s.name }))}
              selectedStationId={selectedStationId === null ? null : String(selectedStationId)}
              onChange={(id) => handleStationChange(id === null ? null : Number(id))}
            />
