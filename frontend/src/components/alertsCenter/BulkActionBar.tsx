...
export function BulkActionBar({ selectedCount, onResolveSelected, onClearSelection }: BulkActionBarProps) {
  ...
  return (
    <div
      className="sticky bottom-0 z-10 -mx-5 -mb-5 mt-2 rounded-b-2xl border-t border-red-100 bg-gradient-to-r from-red-50/80 via-blue-50/60 to-yellow-50/80 px-5 py-3 shadow-lg backdrop-blur-sm sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
      role="toolbar"
